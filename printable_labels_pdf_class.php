...
class printable_labels_pdf
{
	...
	private $margin_right_label; // Margin in cm. from right label (margin means outside label)
    ...
    public function __construct( $labels_config ) {
		...
		$this->flux_start_at_label	= ((isset($labels_config['start_at_label']))?$labels_config['start_at_label']:1); // If not set, 1 that menas at first label
	...
	*/
	public function set_label_style(  ){
		...
		$this->label_style	.= 'margin-right:'.$this->margin_right_label.'cm;';
